function q_triad = TRIAD(N_sun, N_mag, B_sun, B_mag)
...
%straightforward and will not be used on the spacecraft, only for the
%sumulation. B/c the algorithm has the orientation of the same vectors in
